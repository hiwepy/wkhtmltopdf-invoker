...
public interface Invoker
{
    ...
    /**
     * Executes Calibre using the parameters specified by the given invocation request. Parameters not specified by the
     ...
     * 
     * @return The working directory for the Calibre invocation or <code>null</code> if the working directory is derived
    ...
    /**
     * Gets the path to the base directory of the Calibre installation used to invoke Calibre.
     * 
     * @return The path to the base directory of the Calibre installation or <code>null</code> if using the default
     *         Calibre installation.
     */
    File getMavenHome();

    /**
     * Sets the path to the base directory of the Calibre installation used to invoke Calibre. This parameter may be left
     * unspecified to use the default Calibre installation which will be discovered by evaluating the system property
     * <code>maven.home</code> and the environment variable <code>M2_HOME</code>.
     * 
     * @param mavenHome The path to the base directory of the Calibre installation, may be <code>null</code> to use the
     *            default Calibre installation.
     * @return This invoker instance.
     */
    Invoker setMavenHome( File mavenHome );

    /**
     * Get the customized File of the Calibre executable.
     * 
     * @return the custom Calibre executable, otherwise {@code null} 
     */
     ...
     * 
     * @param workingDirectory The working directory for the Calibre invocation, may be <code>null</code> to derive the
