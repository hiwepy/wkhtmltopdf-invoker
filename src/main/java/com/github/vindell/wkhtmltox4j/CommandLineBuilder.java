...
import com.github.vindell.wkhtmltox4j.InvocationRequest.CheckSumPolicy;
import com.github.vindell.wkhtmltox4j.InvocationRequest.ReactorFailureBehavior;
				...
				if (!mavenHome.isDirectory()) {
					...
					if (binDir != null && "bin".equals(binDir.getName())) {
						...
						throw new IllegalStateException(
								"${maven.home} is not specified as a directory: \'" + mavenHomeProperty + "\'.");
					}
				}
			}
